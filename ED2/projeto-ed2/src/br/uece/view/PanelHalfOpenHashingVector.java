...
import br.uece.structures.hashing.halfopen.HalfOpenHashingVector;
import br.uece.structures.hashing.halfopen.Node;
import br.uece.structures.view.ListViewer;

public class PanelHalfOpenHashingVector extends JPanel{
	...
	private HalfOpenHashingVector hashing;

	private ListViewer[] listView;

	public PanelHalfOpenHashingVector() {
		jpSettings = new PanelSettings();
		hashing = new HalfOpenHashingVector();
		container = new JPanel();
		listView = new ListViewer[hashing.getVetor().length];
		// add(jpSettings);
