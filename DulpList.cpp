/* 
 Program ED1 - List Encad Dulp 30/09/18
...
class List{
    ...
    public:
        ...
        void InsertCell_Middle(int value){
            ...
            aux_cell->SetPrevious(aux_middle);
            aux_middle->GetNext()->SetPrevious(aux_cell);
        ...
        void Remove_Init(Cell* wash){
            ...
            this->SetInit(wash->GetPrevious());
            wash->GetPrevious()->SetNext(NULL);
            cout << endl << "=> Delete : " << wash->GetValue() << endl; 
            delete wash;
            this->SetSize(this->GetSize() - 1);
        ...
        void Remove_Middle(Cell* wash){
            ...
            wash->GetPrevious()->SetNext(wash->GetNext());
            wash->GetNext()->SetPrevious(wash->GetPrevious());
            wash->SetNext(NULL);
            wash->SetPrevious(NULL);
            cout << endl << "=> Delete : " << wash->GetValue() << endl; 
            delete wash;
            this->SetSize(this->GetSize() - 1);
...
int main(){
    ...
    system("clear");
    cout << "Program  Dulp List, OO" << endl;
    cout << "ED1" << endl << endl;
    ...
    do{
        ...
        switch(choice){
            ...
            case 3:
                if(list.GetSize() <= 2){
                    cout << endl << "=> Operation not valid, (List small): " << endl << endl;
                }else{
